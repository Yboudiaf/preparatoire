...
public class exerciceBanqueInteret {
	...
	public static void main(String[] args) {
		...
		System.out.println("Erreur de cast interet");
		...
		System.out.println("la valeur aquise pa la somme avec interet simple est:"+df.format(interets));
		System.out.println("la valeur aquise par la somme avec interet composé est:"+df.format(interetc));
